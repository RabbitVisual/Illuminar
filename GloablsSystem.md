...
Este documento define os padrões de uso para componentes globais e diretrizes de UX/UI para manter a consistência e qualidade do projeto  .
...
O projeto utiliza **Font Awesome Pro 7.1.0** configurado localmente para garantir consistência e performance.
